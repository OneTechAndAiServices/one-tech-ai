    ...
    >
      ...
      <Box display="flex" alignItems="center" my={4} flexDirection={['column', 'column', 'row']}>
        <Box width={["100%", "100%", "50%"]}>
          ...
          >
            ...
            <Box
              ...
              sx={{
                background:
                  "linear-gradient(90deg, rgba(244, 201, 97, 1) 0%, rgba(222, 107, 167, 1) 50%, rgba(72, 202, 228, 1) 100%)",
                WebkitBackgroundClip: "text",
                color: "transparent",
                fontSize: "30px",
              }}
        ...
        <Box width={["100%", "100%", "50%"]} data-aos="fade-right">
          ...
          >
            From website development and UI/UX design to AI solutions and
            digital consulting, we deliver innovative and customized strategies
          ...
          <Grid size={{xs:12, sm:6, md:4}} key={index}>
            ...
            >
              <CardContent>
                <Typography
                  variant="h6"
                  sx={{ fontWeight: 400, mb: 1, fontSize: "25px" }}
                >
                  {service.title}
                </Typography>
                <Typography
                ...
                <Typography
                  variant="subtitle2"
                  sx={{ fontWeight: 400, mb: 1, fontSize: "15px" }}
                >
                  Features:
                </Typography>
                <ul style={{ margin: 0, paddingLeft: 20 }}>
