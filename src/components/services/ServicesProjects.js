          ...
          <Grid size={{ xs:12, md:6 }} >
            <Box>
              <Typography
                ...
                component="h2"
                gutterBottom
                sx={{ fontWeight: 500, fontSize: ['48px', '60px', '67px'] }}
                data-aos="fade-left"
              >
                ONE TECH & AI
              </Typography>
              ...
              <Typography
                ...
                data-aos="fade-left"
              >
                Explore some of our most successful and impactful projects that demonstrate our
                expertise in delivering innovative solutions. Each project reflects our commitment
                to quality, creativity, and customer satisfaction, showcasing the real-world
